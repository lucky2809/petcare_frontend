...
export default function Additional() {
    ...
    return (
        <Fragment>
            ...
            <AnimatedCard className={`service  w-full my-5 flex flex-col ${[1, 4].includes(activeStep) ? "justify-start" : "justify-center"} h-full gap-4 items-center  px-10 max-sm:px-5`}>
